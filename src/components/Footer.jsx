...
const Footer = () => {
  return (
    ...
    //   </p>
    //   <p className="text-white text-base">Copyright © Thundeck </p>
    //   <div className="flex justify-center items-center flex-row gap-4">
    //     <a
    //       href="https://github.com/Thundeck"
    //       target="_blank"
    //       rel="noreferrer"
    //       className={`flex p-2 rounded-full bg-white text-gray-900 text-xl lg:text-3xl`}
    //     >
    //       <i className="fa-brands fa-github"></i>
    //     </a>
    //     <a
    //       href="https://www.linkedin.com/in/thundeck/"
    //       target="_blank"
    //       rel="noreferrer"
    //       className={`flex p-2 rounded-full bg-white text-gray-900 text-xl lg:text-3xl`}
    //     >
    ...
    //     </a>
    //     <a
    //       href="mailto:thundeckk@gmail.com"
    //       target="_blank"
    //       rel="noreferrer"
    //       className={`flex p-2 rounded-full bg-white text-gray-900 text-xl lg:text-3xl`}
    //     >
    ...
    //   </div>
    // </div>
    <div className="absolute bottom-0 h-fit w-full bg-blue-800/75 flex  flex-wrap py-5 justify-center text-white items-center ">
      <div className="text-center font-bold ">
        ...
        <button className="bg-green-500 text-white py-2 px-5 mt-2 rounded-lg">
          <Link to="/contact-us">I want to speak with a representant</Link>
        </button>
